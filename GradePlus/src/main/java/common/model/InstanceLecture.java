...
public class InstanceLecture extends JPAEntity {
    ...
    /**
     * Sagt, ob eine ILV freigegeben ist für Anmeldungen.
     */
    @Column(nullable = false)
    ...
    /**
     * Gibt den Status der Freigabe zurück.
     * @return true, falls die ILV freigegeben ist.
     */
